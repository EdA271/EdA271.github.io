window.addEventListener('DOMContentLoaded', () => {
  ...
  const lightningBolt = document.getElementsByClassName('nav-link');
  let i = 0
  ...
  function generateLightningBolt() {
    ...
    lightningBolt.textContent.color = `linear-gradient(to bottom right, ${randomGradient[0]}, ${randomGradient[1]})`;
